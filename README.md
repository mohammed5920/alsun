...
Project Alsun provides a platform for administrators and teachers to create structured educational content (Courses → Modules → Variants) and for users to purchase access to the specific material they need. It can adapt to any form of educational content. Originally designed for language content, it features a flexible tagging and variant system that can adapt to any form and category of content.
